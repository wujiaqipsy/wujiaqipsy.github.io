  ...
  timeline: [
    ...
    {// 收集被试信息
      ...
      on_finish: function (data) {
        ...
        // 新增traditional matching task code
...
var instr_repractice = { //在这里呈现文字recap，让被试再记一下
  ...
  pages: function () {
    ...
    return ["<p class='header' style='font-size:35px; line-height:30px;'>您的正确率未达到进入正式实验的要求。</p>",
      ...
      <p class='footer' style='font-size:35px'>如果二者<span style="color: lightgreen;">不匹配</span>，请按<span style="color: lightgreen;"> ${key_match[1]} 键</p>
...
var instr_self = {
  ...
  pages: function () {
    ...
    return [
      start +
      `<p class='footer' style='font-size: 35px; line-height: 30px;'>本阶段您需要将图形分为“自我”图形与“非自我”图形。</p>
          <p class='footer' style='color:white; font-size: 35px;'>如果出现的图形<span style="color: lightgreen; font-size:35px">是自我图形</span>，请按<span style="color: lightgreen; font-size:35px">自我标签对应的按键。</span></p>
          <p class='footer' style='color:white; font-size: 35px;'>如果自我标签出现在<span style="color: lightgreen; font-size:35px">左边，请按←键；</span></p>
          <p class='footer' style='color:white; font-size: 35px;'>如果自我标签出现在<span style="color: lightgreen; font-size:35px">右边，请按→键。</span></p>
          <p class='footer' style='color:white; font-size: 35px;'>如果出现的图形<span style="color: lightgreen; font-size:35px">不是自我图形</span>，请按<span style="color: lightgreen; font-size:35px">非自我标签对应的按键。</span></p>
          <p class='footer' style='color:white; font-size: 35px;'>如果非自我标签出现在<span style="color: lightgreen; font-size:35px">左边，请按←键；</span></p>
          <p class='footer' style='color:white; font-size: 35px;'>如果非自我标签出现在<span style="color: lightgreen; font-size:35px">右边，请按→键。</span></p>
          <p class='footer' style='color: lightgreen; font-size:35px"; line-height: 30px;'>本阶段为练习阶段，请您尽可能又快又准地按键。</p>`
      + end];
  },
  show_clickable_nav: true,
  button_label_previous: " <span class='add_' style='color:black; font-size: 20px;'> 返回</span>",
...
var instr_repractice_self = { //在这里呈现文字recap，让被试再记一下
  ...
  pages: function () {
    ...
    return ["<p class='header' style='font-size:35px; line-height:35px;'>您的正确率未达到进入正式实验的要求。</p>",
      start + `<div class="box">${tmpI}</div>`,
      `<p class='footer' style='font-size: 35px; line-height: 30px;'>您的任务是将图形分为“自我”图形与“非自我”图形，
          <p class='footer' style='color:white; font-size: 35px;'>如果出现的图形<span style="color: lightgreen; font-size:35px">是自我图形</span>，请按<span style="color: lightgreen; font-size:35px">自我标签对应的按键。</span></p>
          <p class='footer' style='color:white; font-size: 35px;'>如果自我标签出现在<span style="color: lightgreen; font-size:35px">左边，请按←键；</span></p>
          <p class='footer' style='color:white; font-size: 35px;'>如果自我标签出现在<span style="color: lightgreen; font-size:35px">右边，请按→键。</span></p>
          <p class='footer' style='color:white; font-size: 35px;'>如果出现的图形<span style="color: lightgreen; font-size:35px">不是自我图形</span>，请按<span style="color: lightgreen; font-size:35px">非自我标签对应的按键。</span></p>
          <p class='footer' style='color:white; font-size: 35px;'>如果非自我标签出现在<span style="color: lightgreen; font-size:35px">左边，请按←键；</span></p>
          <p class='footer' style='color:white; font-size: 35px;'>如果非自我标签出现在<span style="color: lightgreen; font-size:35px">右边，请按→键。</span></p>
          <p class='footer' style='color: lightgreen; font-size:35px"; line-height: 30px;'>请您尽可能又快又准地按键。</p></span>`,
      middle + end];
  },
  show_clickable_nav: true,
  button_label_previous: " <span class='add_' style='color:black; font-size: 20px;'> 返回</span>",
...
let self = {
  ...
  randomize_order: true,
  repetitions: 8,//8/9；每个block72个trial;    12；每个条件120个trial；自我240个trial，单block96个trial
  on_finish: function () {
    $("body").css("cursor", "default"); //鼠标出现
  }
}
...
let p_self = {
  type: jsPsychHtmlKeyboardResponse,
  stimulus: `
      <p>请您将右手的食指与无名指放在相应按键上，准备进入<span style='color: yellow;'>自我图形分类任务</span></p>
