...
var instr_friend = {
  ...
  pages: function () {
    ...
    return [
      start +
      `<p class='footer' style='font-size: 35px; line-height: 30px;'>本阶段您需要将图形分为“朋友”图形与“非朋友”图形。</p>
          <p class='footer' style='color:white; font-size: 35px;'>如果出现的图形<span style="color: lightgreen; font-size:35px">是朋友图形</span>，请按<span style="color: lightgreen; font-size:35px">朋友标签对应的按键。</span></p>
          <p class='footer' style='color:white; font-size: 35px;'>如果朋友标签出现在<span style="color: lightgreen; font-size:35px">左边，请按←键；</span></p>
          <p class='footer' style='color:white; font-size: 35px;'>如果朋友标签出现在<span style="color: lightgreen; font-size:35px">右边，请按→键。</span></p>
          <p class='footer' style='color:white; font-size: 35px;'>如果出现的图形<span style="color: lightgreen; font-size:35px">不是朋友图形</span>，请按<span style="color: lightgreen; font-size:35px">非朋友标签对应的按键。</span></p>
          <p class='footer' style='color:white; font-size: 35px;'>如果非朋友标签出现在<span style="color: lightgreen; font-size:35px">左边，请按←键；</span></p>
          <p class='footer' style='color:white; font-size: 35px;'>如果非朋友标签出现在<span style="color: lightgreen; font-size:35px">右边，请按→键。</span></p>
...
var instr_repractice_friend = { //在这里呈现文字recap，让被试再记一下
  ...
  pages: function () {
    ...
    return ["<p class='header' style='font-size:35px; line-height:35px;'>您的正确率未达到进入正式实验的要求。</p>",
      start + `<div class="box">${tmpI}</div>`,
      `<p class='footer' style='font-size: 35px; line-height: 30px;'>您的任务是将图形分为“朋友”图形与“非朋友”图形，
          <p class='footer' style='color:white; font-size: 35px;'>如果出现的图形<span style="color: lightgreen; font-size:35px">是朋友图形</span>，请按<span style="color: lightgreen; font-size:35px">朋友标签对应的按键。</span></p>
          <p class='footer' style='color:white; font-size: 35px;'>如果朋友标签出现在<span style="color: lightgreen; font-size:35px">左边，请按←键；</span></p>
          <p class='footer' style='color:white; font-size: 35px;'>如果朋友标签出现在<span style="color: lightgreen; font-size:35px">右边，请按→键。</span></p>
          <p class='footer' style='color:white; font-size: 35px;'>如果出现的图形<span style="color: lightgreen; font-size:35px">不是朋友图形</span>，请按<span style="color: lightgreen; font-size:35px">非朋友标签对应的按键。</span></p>
...
let p_friend = {
  type: jsPsychHtmlKeyboardResponse,
  stimulus: `
      <p>请您将右手的食指与无名指放在相应按键上，准备进入<span style='color: yellow;'>朋友图形分类任务</span></p>
