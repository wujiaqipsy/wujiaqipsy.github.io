...
var instr_friend = {
  ...
  pages: function () {
    ...
    return [
      start +
      `<p class='footer' style='font-size: 35px; line-height: 30px;'>本阶段您需要将图形分为“朋友”图形以及“非朋友”图形</p>
          <p class='footer' style='color:white; font-size: 35px;'>如果出现的图形<span style="color: lightgreen; font-size:35px">是与“朋友”标签对应的图形</span>，请按<span style="color: lightgreen; font-size:35px">${key[0]}</span>
          <p class='footer' style='color:white; font-size: 35px;'>如果出现的图形<span style="color: lightgreen; font-size:35px">不是与“朋友”标签对应的图形</span>，请按<span style="color: lightgreen; font-size:35px">${key[1]}</span>
...
var instr_repractice_friend = { //在这里呈现文字recap，让被试再记一下
  ...
  pages: function () {
    ...
    return ["<p class='header' style='font-size:35px; line-height:30px;'>您的正确率未达到进入下一阶段练习的要求。</p>",
      start + `<div class="box">${tmpI}</div>`,
      `<p class='footer' style='font-size:35px; line-height:35px;'>您的任务是将图形分为“朋友”图形以及“非朋友”图形
          <p class='footer' style='font-size:35px; line-height:30px;'>如果出现的图形<span style="color: lightgreen;">是与“朋友”标签对应的图形</span>，请按 <span style="color: lightgreen;">${key[0]}</span></p>
          <p class='footer' style='font-size:35px; line-height:30px;'>如果出现的图形<span style="color: lightgreen;">不是与“朋友”标签对应的图形</span>，请按 <span style="color: lightgreen;">${key[1]}</span></p>
...
let friend = {
  ...
  randomize_order: true,
  repetitions: 2,//16;trial分配：朋友160；朋友&生人80
  on_finish: function () {
    $("body").css("cursor", "default"); //鼠标出现
  }
}
...
let p_friend = {
  type: jsPsychHtmlKeyboardResponse,
  stimulus: `
      <p>请您将食指与无名指放在相应按键上，准备进入<span style='color: yellow;'>朋友图形分类任务</span></p>
